...
import { Create_Exercise } from "./components/trainer/views/Exercises/create_exercise";
import { Create_training } from "./components/trainer/views/Training Templates/create_training";
