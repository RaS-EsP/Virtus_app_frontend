...
export const SettingsButton = () => {
  return (
    <svg
      ...
      strokeWidth={1.5}
      stroke="currentColor"
      className="w-5 h-5 cursor-pointer hover:text-ThirdColor"
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        } transition-all ease-in-out duration-300 absolute z-20 top-5 right-0  bg-white  text-sm rounded-md drop-shadow-lg  w-32 break-words text-FirstColor`}
      >
        <ul>
          {getAuthToken() ? (
            <>
            ...
            <>
              <li className="  hover:bg-FourthColor rounded-t-md    cursor-pointer ">
              ...
              <li className="  hover:bg-FourthColor  border-t border-FourthColor cursor-pointer ">
                <a className="block p-2  " href="/trainer/login">
                  Login as trainer
                </a>
              </li>
              <li className="hover:bg-FourthColor  border-t border-FourthColor cursor-pointer ">
                <a className="block p-2" href="/client/login">
                  Login as client
                </a>
              </li>
              <li className="hover:bg-FourthColor rounded-b-md border-t border-FourthColor cursor-pointer ">
                <a className="block p-2" href="/trainer/signup">
                  Sign up
                </a>
              </li>
            </>
